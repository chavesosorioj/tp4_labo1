...
#include "Employee.h"
#include "menu.h"
#define EMPLOYEE "data.csv"
#define EMPLOYEE_NEW "employeeNew.csv"
...
int main() {
	...
	do {
		...
		switch (option) {
		case 1:
			controller_loadFromText(EMPLOYEE, listEmployee);
			break;
		case 2:
			while (add != 2) {
		...
		case 6:
			...
			break;
		case 7:
			controller_saveAsText(EMPLOYEE_NEW, listEmployee);
			break;
		case 8:
